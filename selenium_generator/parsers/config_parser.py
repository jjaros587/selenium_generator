...
class ConfigUpdater:
    ...
    def _verify_output_folder(self, key="params"):
        """
        Method checks configuration for parameters of file with Test report add the default value if the related object
        is not specified.
...
class ConfigParser:
    ...
    def __init__(self, config_path='config.yaml',
        ...
        arg_config = arg_parser().get_config()
        ...
        config_updater(self).update_config()
